'''
runuing in terminal as: spark-submit reviews_sentiment.py reviews.csv output

Conduct sentiment analysis on the comments and generate polarity score for each comment
'''
import sys
...
def main(inputs, output):
    ...
    .option('escape', '"') .csv(output, mode='overwrite')
